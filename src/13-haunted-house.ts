...
const tick = () => {
  ...
  ghost1.position.y = Math.sin(ghost1Angle) * 1.5 + 1;
  ...
  ghost2.position.y = Math.sin(ghost2Angle) * 1.7 + 1;
  ...
  ghost3.position.y = Math.sin(ghost3Angle) * 2 + 1;
